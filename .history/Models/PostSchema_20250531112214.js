...
const postSchema = new mongoose.Schema({
  personalDetails: { type: mongoose.Schema.Types.ObjectId, ref: 'PersonalDetails', required: true },
  userCommunity: { type: mongoose.Schema.Types.ObjectId, ref: 'UserCommunity', required: true },
