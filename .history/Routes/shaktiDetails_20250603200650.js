...
router.put('/update-business-name-with-defaults', authenticateJWT, async (req, res) => {
  try {
    const userId = req.userId;
    ...
    // Ensure ideaDetails exists
    if (!business.ideaDetails) {
      business.ideaDetails = {};
    }
    
    // Set default values for required fields if they don't exist
    if (!business.ideaDetails.Business_Location) {
      business.ideaDetails.Business_Location = business.ideaDetails.Business_Location || '';
    }
    if (!business.ideaDetails.Buisness_City) {
      business.ideaDetails.Buisness_City = business.ideaDetails.Buisness_City || '';
    }
