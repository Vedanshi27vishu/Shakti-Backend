...
const { createPost, getPostsByInterest, likePost, commentOnPost, updateComment, de } = require('../Controllers/postController');
...
router.put('/posts/:postId/comments/:commentId', requireAuth, updateComment);
